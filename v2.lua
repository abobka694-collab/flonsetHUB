...
VisualsGun.AddToggle("Enable Gun ESP", false, function(v)
    if v then
        GunESP:Enable()
    else
        GunESP:Disable()
...
VisualsGun.AddToggle("Show Highlight", true, function(v)
    GunESP:SetShowHighlight(v)
end)

VisualsGun.AddToggle("Show Text", true, function(v)
    GunESP:SetShowText(v)
end)

VisualsGun.AddSlider("Max Distance", 100, 1000, 500, function(v)
